...
Сгенерируй 10 карточек: 9 вопросов + 1 инсайт"""
        ...
        phase = "action"
        phase_desc = "ЭТАП 5: ПЛАН (карточки 37-45)"
        instructions = """Создаём план:
- Готов попробовать одно изменение?
- Сделаешь паузу при триггере?
- Можешь попросить поддержки?

Сгенерируй 9 вопросов БЕЗ инсайтов."""
    else:
        phase = "final"
        phase_desc = "ФИНАЛ: ИТОГОВАЯ СВОДКА (карточка 46)"
        instructions = """Создай ОДНУ финальную карточку-инсайт (type: "insight"):

Структура (3-5 предложений максимум):
1. Суммируй основную проблему и триггер
2. Опиши выявленный паттерн (мысль → реакция)
3. Дай 1-2 конкретных действия на неделю
4. Мотивируй: "Ты уже сделал первый шаг"

Сгенерируй ТОЛЬКО 1 карточку типа insight с category "final"."""
